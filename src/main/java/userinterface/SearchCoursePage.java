...
public class SearchCoursePage extends PageObject {
    ...
    public static final Target  SELECT_COURSE= Target.the("Da click par a buscar el curso").located(By.xpath("//h4[(contains(text(),'Recursos Automatización Bancolombia')]"));
